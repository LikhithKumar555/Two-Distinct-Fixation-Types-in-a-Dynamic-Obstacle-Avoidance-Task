...
observation_space_size_x, observation_space_size_y = (
    40,
    60,
)  # other possible sizes [80, 60]

# environment related parameters
velocity = 1 / 3  # 1 / (FPS/20)
level_size_x = (
    observation_space_size_x  # level_size_y determined by walls (last wall ends level)
)
wall_size = 1
drift_tile_x_size = 1
...
pre_trial_steps = (
    20  # steps spaceship has to take to reach starting_position in experimental setup
)
# can range from 0 - observation_space_y/2

# upscaling for visualization on screen
scaling = 18  # 14 for debugging; 18 for experimentation
scaling_tiny_vis = 2

# edge size for screen beyond walls and bottom
edge = 34  # 28 for debugging; 34 perfect for large screen with scaling = 18
