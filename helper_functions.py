...
def adjust_player_positions(
    player_starting_position, player_positions, scaling, tiny_visualization=False
):
    """
    param
    return
    """
    adjusted_player_starting_position = [
        (player_starting_position[0] + edge - 0.5 * agent_size_x) * scaling,
